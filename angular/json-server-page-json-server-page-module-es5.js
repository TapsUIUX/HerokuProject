...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["json-server-page-json-server-page-module"], {
  /***/
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/generator-box/generator-box.component.html":
  /*!******************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/generator-box/generator-box.component.html ***!
    \******************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJsonServerPageComponentsGeneratorBoxGeneratorBoxComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n<div class=\"container generator-wrapper font-light\">\n\n  <p  class=\"text-app-header fs-25 p-t-25 p-b-20 \"> JSON Engine </p>\n\n      <div class=\"row font-light\">\n\n            <div class=\"col-12 col-sm-6\" >\n                <button class=\"btn btn-light pull-left m-r-20 m-t-5 m-b-5 \"   (click)=\"onClear()\"  > Clear <i class=\"fa fa-redo\"></i> </button>\n                <button class=\"btn btn-light   m-t-5 m-b-5\"  color=\"default\" (click)=\"onExample()\" [disabled]=\"inputParams==example\"  > Load Example <i class=\"fa fa-edit\"></i></button>\n            </div>\n            <div class=\"col-12 col-sm-6\" >\n                <button class=\"btn btn-light pull-right server-btns-right  m-r-20 m-t-5 m-b-5\"   (click)=\"onCopy()\" [disabled]=\"isDisabled\"> Copy <i class='fa fa-copy'></i> </button>\n                <button class=\"btn btn-light pull-right  m-r-20 server-btns-right m-t-5 m-b-5\"  (click)=\"onDownload()\" [disabled]=\"isDisabled\"  > Download <i class='fa fa-download'></i></button>\n            </div>\n\n        \n\n      </div>\n\n   <div class=\"row p-t-20 \">\n\n\n    <div class=\"col-12 col-sm-4 \">\n      <p class=\"text-app fs-16 \">Prameter Input</p>\n    <textarea id=\"inputField\" class=\"text-area fs-16 text-app col-12 app-border no-outline\" [ngClass]=\"(invalidJson)?'invalid':(!invalidJson)?'valid':''\" name=\"\"  cols=\"30\" rows=\"20\" [(ngModel)]=\"inputParams\" [placeholder]=\"inputPlaceholder\" ></textarea>\n  </div>\n\n\n  <div class=\"col-12 col-sm-4 tap-aligner\">\n\n    \n   <div class=\"text-center tap-item-to-align\">\n\n\n    <div *ngIf=\"true\" class=\"clearfix  tap-aligner p-b-20 \">\n      <!-- <div class=\"tap-lf-f bg-app-primary  br-50 tap-enlarge-20 pull-left\">\n       <i class=\"fa fa-frog fs-25 animated wobble infinite text-white tap-lf-f tap-s-text\"></i>\n      </div> -->\n      <div *ngIf=\" !spin\"  class=\"tap-lf-f bg-app-primary  br-50 tap-enlarge-20 pull-left m-auto\">\n       <i class=\"fa fa-hdd fs-25 text-white tap-lf-f tap-s-text\"></i>\n      </div>\n\n      <div *ngIf=\"spin\"  class=\"tap-lf-f bg-app-primary  br-50 tap-enlarge-20 pull-left m-auto\">\n       <i class=\"fa fa-hdd fs-25 animated heartBeat infinite text-white tap-lf-f tap-s-text\"></i>\n      </div>\n    </div>\n\n\n       <button class=\"app-btn btn-app-primary btn-block no-outline\" (click)=\"onGen('json')\"> Generate JSON \n       &nbsp; <i class=\"fa fa-code\"></i>\n       </button> \n\n    \n   \n         <button class=\"app-btn btn-app-primary btn-block no-outline\" (click)=\"onGen('sql')\"> Generate SQL \n          &nbsp;<i class=\"fa fa-hockey-puck\"></i>\n         </button> \n   \n    \n   \n         <button class=\"app-btn btn-app-primary btn-block no-outline\" (click)=\"onGen('api')\"> Generate URL \n          &nbsp;<i class=\"fa fa-link\"></i>\n         </button> \n\n     \n   </div>\n\n \n\n </div>\n\n\n \n\n\n\n <div class=\"col-12 col-sm-4\">\n  <p class=\"text-app fs-16 \">Output</p>\n<pre  #outPut class=\"col-12 fs-16   no-outline font-light\" name=\"\" id=\"outPut\" cols=\"30\" rows=\"20\" [innerHTML]=\"outPutData\" placeholder=\"Out Put\"\n\n></pre>\n</div>\n\n\n\n   </div>\n    \n\n   \n\n\n   \n\n</div>\n";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/how-to-use/how-to-use.component.html":
  /*!************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/how-to-use/how-to-use.component.html ***!
    \************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJsonServerPageComponentsHowToUseHowToUseComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n    <div class=\" p-t-50 text-app\" >\n \n\n        <!-- uk-scrollspy=\"target:> div ;cls: uk-animation-scale-up; delay:400\" -->\n\n        <div  class=\"row fs-18\" >\n\n          <div class=\"col-12 col-md-3\" >\n              <div class=\"\">\n                  <h3 class=\"text-app fs-25\">Step 1</h3>\n                  <p>create input parameter structure using <code>rand</code> function.</p>\n              </div>\n          </div>\n\n          <div class=\"col-md-1 \"></div>\n\n          <div class=\"col-12 col-md-3 \">\n              <div class=\"\">\n                  <h3 class=\"text-app fs-25\">Step 2</h3>\n                  <p>click on the button depending on your requirement.</p>\n              </div>\n          </div>\n\n          <div class=\"col-md-1 \"></div>\n\n          <div class=\"col-12 col-md-3 \">\n              <div class=\"\">\n                  <h3 class=\"text-app fs-25\">Step 3</h3>\n                  <p>copy or download the genertated URL, JSON or SQL statements to used them it in your application.</p>\n              </div>\n          </div>\n\n        </div>\n\n      </div>\n";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/param-info/param-info.component.html":
  /*!************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/param-info/param-info.component.html ***!
    \************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJsonServerPageComponentsParamInfoParamInfoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n\n    <div class=\"container p-t-25 font-light\" id=\"target\">\n\n        \n          <div class=\"fs-25 text-app-header  \">\n               Available Parameters for the <code>rand</code> Function\n          </div>\n       \n\n       \n\n          <div class=\"col-12 p-t-25 p-l-0\">\n\n                  <div class=\"fs-18 text-app font-light\" >\n\n                    <p> <code>repeat : [number]</code> specifies how many record need to be created, Max limit 1000, default 10 </p>\n                    <p> <code>rand(name)</code> generates random firstname and lastnames </p>\n                    <p> <code>rand(gender)</code> generates random gender </p>\n                    <p> <code>rand(address)</code> generates random address </p>\n                    <p> <code>rand(number,[lowerLimit],[upperLimit])</code> generates random number between lower and upper limit </p>\n                    <p> <code>rand(text,[limit])</code> generates random texts where text length is equlal with the limit, default 50, Max 1000 </p>\n                    <p> <code>rand(city)</code> generates random American city names </p>\n                    <p> <code>rand(zip)</code> generates random American Zip codes </p>\n                    <p> <code>rand(state)</code> generates random American state names </p>\n                    <p> <code>rand(ssn)</code> generates random ssn </p>\n                    <p> <code>rand(email)</code> generates random email </p>\n                    <p> <code>rand(image,face)</code> generates random face image links </p>\n\n\n\n                  </div>\n\n          </div>\n\n\n      </div>\n";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.html":
  /*!*******************************************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.html ***!
    \*******************************************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJsonServerPageContainerJsonServerPageContainerJsonServerPageContainerComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/json-server-page/components/generator-box/generator-box.component.scss":
  /*!****************************************************************************************!*\
    !*** ./src/app/json-server-page/components/generator-box/generator-box.component.scss ***!
    \****************************************************************************************/
  ...
  /***/
  function srcAppJsonServerPageComponentsGeneratorBoxGeneratorBoxComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".generator-wrapper textarea {\n  border: 1px solid #252525 !important;\n  color: rgba(255, 255, 255, 0.795) !important;\n  background-color: #252525;\n  resize: vertical;\n  resize: none;\n  border-radius: 5px !important;\n  height: 400px;\n  font-size: 15px !important;\n}\n.generator-wrapper li {\n  word-break: break-words;\n}\n.generator-wrapper pre {\n  white-space: normal;\n}\n.generator-wrapper .invalid {\n  color: red !important;\n  border-color: red !important;\n}\n.generator-wrapper button {\n  line-height: 10px;\n}\n.generator-wrapper .page-info {\n  padding: 15px 0 10px 0;\n}\n.generator-wrapper .page-info textarea {\n  background-color: white !important;\n  height: 300px;\n  resize: none;\n  border: none !important;\n  resize: none;\n  outline: none;\n}\n.generator-wrapper pre {\n  padding: 5px;\n  border: 1px solid #252525 !important;\n  background-color: #252525;\n  height: 400px;\n  white-space: normal;\n  word-break: break-word;\n  font-size: inherit !important;\n  border-radius: 5px !important;\n  color: rgba(255, 255, 255, 0.795) !important;\n}\n.generator-wrapper pre .string {\n  color: #9ae29a;\n}\n.generator-wrapper pre .number {\n  color: darkorange;\n}\n.generator-wrapper pre .boolean {\n  color: #6464f3;\n}\n.generator-wrapper pre .null {\n  color: magenta;\n}\n.generator-wrapper pre .key {\n  color: #ffffff;\n}\n.generator-wrapper pre .br {\n  color: red;\n  font-weight: bold !important;\n}\n.generator-wrapper pre .red {\n  color: red;\n}\n.generator-wrapper pre span {\n  font-size: 12px !important;\n}\n.generator-wrapper pre a {\n  font-size: 15px !important;\n}\n@media only screen and (max-width: 900px) {\n  .server-btns-right {\n    float: left !important;\n    margin-top: 15px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },

  /***/
  "./src/app/json-server-page/components/generator-box/generator-box.component.ts":
  /*!**************************************************************************************!*\
    !*** ./src/app/json-server-page/components/generator-box/generator-box.component.ts ***!
    \**************************************************************************************/

  /*! exports provided: GeneratorBoxComponent */

  /***/
  function srcAppJsonServerPageComponentsGeneratorBoxGeneratorBoxComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GeneratorBoxComponent", function () {
      return GeneratorBoxComponent;
    });
    /* harmony import */
    ...
    var _services_generate_json_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var GeneratorBoxComponent = /*#__PURE__*/function () {
      function GeneratorBoxComponent(_gen, _datePipe) {
        var _this41 = this;

        _classCallCheck(this, GeneratorBoxComponent);

        this._gen = _gen;
        this._datePipe = _datePipe;
        this.counter_e = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.example = "{\n    \"repeat\": \"1\",\n    \"name\": \"rand(name)\",\n    \"gender\": \"rand(gender)\",\n    \"age\": \"rand(number,20,50)\",\n    \"address\": \"rand(address)\",\n    \"salary\": \"rand(number,2000,50000)\",\n    \"phone\": \"rand(phone)\",\n    \"ssn\": \"rand(ssn)\",\n    \"title\": \"rand(text)\",\n    \"email\": \"rand(email)\",\n    \"face\":\"rand(image,face)\"\n  }";
        this.outPutData = ""; //url = "http://localhost:3000"
        ...
        this.validateJson = function () {
          if (!_this41.inputParams) {
            _this41.invalidJson = true;
            _this41.outPutData = _this41.error;
            _this41.isDisabled = true;
            return;
          }

          if (!_this41.isJson(_this41.inputParams)) {
            _this41.invalidJson = true;
            _this41.outPutData = _this41.error;
            _this41.isDisabled = true;
          } else if (_this41.isJson(_this41.inputParams)) {
            _this41.invalidJson = false;
            _this41.outPutData = "";
            _this41.spin = true;
          }
        };

        this.onGenrateJson = function () {
          if (!_this41.invalidJson) {
            var temp;

            _this41._gen.generateJson(_this41.inputParams); //trigger the Call


            _this41._gen.getGeneratedJson().subscribe(function (res) {
              var temp = JSON.stringify(res); //temp = JSON.stringify(res,null,'\t');
              //temp = JSON.stringify(res,undefined,2);

              temp = _this41.syntaxHighlight(temp);
              _this41.outPutData = temp.replace(/,/gi, ",<br>").replace(/{/gi, "<span class='br'>{</span class='br'><br>").replace(/}/gi, "<br><span class='br'>}</span>").replace(/\[/gi, "[<br>").replace(/\]/gi, "<br>]");
        ...
        this.onGenrateSql = function () {
          if (!_this41.invalidJson) {
            ...
            _this41._gen.getGeneratedJson().subscribe(function (res) {
              ...
              temp = _this41.convertToSql(temp);
              _this41.outPutData = temp.replace(/INSERT INTO/gi, "<span><span class='key'>INSERT INTO</span>").replace(/VALUE/gi, "<span class='key'>VALUE</span>").replace(/YOUR_TABLE_NAME/gi, "<span class='red'>YOUR_TABLE_NAME</span><br>").replace(/;/gi, ";</span><br>");
        ...
        this.convertToSql = function (arg) {
          // INSERT INTO table_name (column1, column2, column3, ...)
          // VALUES (value1, value2, value3, ...);
          var tname = "YOUR_TABLE_NAME";
          ...
          try {
            var _loop = function _loop() {
              ...
              var items = "";
              var values = ""; // let url = "http://localhost:3000/";
              //let url = "http://localhost:3000/";

              var temp = JSON.stringify(item).replace(/\{|\}/gi, "").replace(/http:\/\/www.serverdummies.com\//gi, "####").split(","); // let temp =  JSON.stringify(item).replace(/\{|\}/gi,"").split(",") ;
              //console.log(temp)
              ...
              items = items.trim().slice(1).replace(/"/g, "`"); // console.log(items,values)

              values = values.replace(/\####/gi, "http://www.serverdummies.com/"); //values = values.replace(/\*/gi,"https://serverdummies.com/");
      ...
      _createClass(GeneratorBoxComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.error = "<span class='red'>Error!!!<br> please check input parameters/JSON Format</span>";
        }
      }, {
        key: "ngAfterContentInit",
        value: function ngAfterContentInit() {// let elem = document.querySelector('#inputField') as HTMLElement;
          // elem.focus()
        }
      }, {
        key: "onClear",
        ...
        value: function destroyClickedElement(event) {
        ...
        key: "onGenrateApi",
        value: function onGenrateApi() {
          if (!this.invalidJson) {
            var temp = this.url + "/api/generate?" + this._gen.generateAPI(this.inputParams);

            temp = temp.replace(/%20/g, ""); //replace(/\%7B/g,"{").replace(/\%7D/g,"}")

            this.outPutData = "<a href=".concat(temp, " target='blank' > ").concat(temp, "</a> ");
            this.checkBtn(this.outPutData);
          } else {
            this.outPutData = this.error;
            this.isDisabled = true;
          }
        }
      }]);
    ...
    GeneratorBoxComponent.ctorParameters = function () {
      return [{
        type: _services_generate_json_service__WEBPACK_IMPORTED_MODULE_2__["GenerateJsonService"]
      }, {
    ...
    GeneratorBoxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! ./generator-box.component.scss */
      "./src/app/json-server-page/components/generator-box/generator-box.component.scss"))["default"]]
    })], GeneratorBoxComponent);
    /***/
  },

  /***/
  "./src/app/json-server-page/components/how-to-use/how-to-use.component.scss":
  /*!**********************************************************************************!*\
    !*** ./src/app/json-server-page/components/how-to-use/how-to-use.component.scss ***!
    \**********************************************************************************/
  ...
  /***/
  function srcAppJsonServerPageComponentsHowToUseHowToUseComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".uk-card-default {\n  box-shadow: inset 1px 2px 20px 4px #ebecf3;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },

  /***/
  "./src/app/json-server-page/components/how-to-use/how-to-use.component.ts":
  /*!********************************************************************************!*\
    !*** ./src/app/json-server-page/components/how-to-use/how-to-use.component.ts ***!
    \********************************************************************************/
  ...
  /***/
  function srcAppJsonServerPageComponentsHowToUseHowToUseComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HowToUseComponent", function () {
    ...
    var HowToUseComponent = /*#__PURE__*/function () {
      function HowToUseComponent() {
        _classCallCheck(this, HowToUseComponent);
      }

      _createClass(HowToUseComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    HowToUseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-how-to-use',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./how-to-use.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/how-to-use/how-to-use.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./how-to-use.component.scss */
      "./src/app/json-server-page/components/how-to-use/how-to-use.component.scss"))["default"]]
    })], HowToUseComponent);
    /***/
  },

  /***/
  "./src/app/json-server-page/components/param-info/param-info.component.css":
  /*!*********************************************************************************!*\
    !*** ./src/app/json-server-page/components/param-info/param-info.component.css ***!
    \*********************************************************************************/
  ...
  /***/
  function srcAppJsonServerPageComponentsParamInfoParamInfoComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2pzb24tc2VydmVyLXBhZ2UvY29tcG9uZW50cy9wYXJhbS1pbmZvL3BhcmFtLWluZm8uY29tcG9uZW50LmNzcyJ9 */";
    /***/
  },

  /***/
  "./src/app/json-server-page/components/param-info/param-info.component.ts":
  /*!********************************************************************************!*\
    !*** ./src/app/json-server-page/components/param-info/param-info.component.ts ***!
    \********************************************************************************/

  /*! exports provided: ParamInfoComponent */

  /***/
  function srcAppJsonServerPageComponentsParamInfoParamInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ParamInfoComponent", function () {
      return ParamInfoComponent;
    });
    /* harmony import */
    ...
    var ParamInfoComponent = /*#__PURE__*/function () {
      function ParamInfoComponent() {
        _classCallCheck(this, ParamInfoComponent);
      }

      _createClass(ParamInfoComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.exampleParam = "{ <br> \"repeat\":\"1\",<br>\n    \"name\":\"rand(name)\",<br>\n    \"gender\":\"rand(gender)\",<br>\n    \"age\":\"rand(number,1,50)\",<br>\n    \"address\":\"rand(address)\",<br>\n    \"salary\" :\"rand(number,2000,50000)\",<br>\n    \"phone\":\"rand(phone)\",<br>\n    \"ssn\":\"rand(ssn)\",<br>\n    \"title\":\"rand(text)\",<br>\n    \"email\":\"rand(email)\",<br>\n    \"face\":\"rand(image,face)\"<br> }";
          this.exampleParam = JSON.stringify(this.exampleParam, null, '\t');
        }
      }]);
    ...
    ParamInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-param-info',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./param-info.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/components/param-info/param-info.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./param-info.component.css */
      "./src/app/json-server-page/components/param-info/param-info.component.css"))["default"]]
    })], ParamInfoComponent);
    /***/
  },

  /***/
  "./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.scss":
  /*!*****************************************************************************************************************!*\
    !*** ./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.scss ***!
    \*****************************************************************************************************************/
  ...
  /***/
  function srcAppJsonServerPageContainerJsonServerPageContainerJsonServerPageContainerComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "header {\n  padding: 10px 0 10px 0;\n  position: fixed;\n  z-index: 20;\n  background-image: linear-gradient(to bottom right, #2d2877, #6277eb);\n}\nheader #logo #title {\n  font-size: 30px;\n  font-weight: 700;\n  color: white;\n  text-shadow: 1px 1px 10px #181515 !important;\n}\nheader #logo #count {\n  font-size: 10px;\n  color: white;\n  margin-top: 13px;\n}\nheader #logo div {\n  margin-bottom: 0px !important;\n}\nfooter {\n  height: 40px;\n  background-image: linear-gradient(to bottom right, #2d2877, #6277eb);\n  font-size: 10px;\n  color: white;\n  margin-top: 15px;\n}\nfooter div {\n  margin: 0 auto;\n  width: 50px !important;\n  padding-top: 15px;\n}\n.padding-top-75 {\n  padding-top: 75px;\n}\n.padding-top-55 {\n  padding-top: 55px;\n}\n.hero-area {\n  padding-top: 75px;\n  min-height: 250px;\n  background-color: #3f51b5;\n  font-size: 18px;\n  font-weight: 300;\n  line-height: 40px;\n  color: white;\n  background-image: linear-gradient(to bottom right, #2d2877, #6277eb);\n}\n.hero-area p {\n  line-height: 5px;\n}\n@media screen and (max-width: 400px) {\n  .hero-area {\n    min-height: 500px;\n  }\n}\n.links a {\n  color: white;\n}\n.text-shadow {\n  text-shadow: 1px 1px 10px grey !important;\n}\n.fixed {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n}\n.mat-tab-wrap {\n  background-color: white;\n}\n.api-section div {\n  word-break: break-word;\n  line-height: 1.2rem;\n}\n.api-section a {\n  line-height: 1.2rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },

  /***/
  "./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.ts":
  /*!***************************************************************************************************************!*\
    !*** ./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.ts ***!
    \***************************************************************************************************************/

  /*! exports provided: JsonServerPageContainerComponent */

  /***/
  function srcAppJsonServerPageContainerJsonServerPageContainerJsonServerPageContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JsonServerPageContainerComponent", function () {
      return JsonServerPageContainerComponent;
    });
    /* harmony import */
    ...
    var _services_demo_link_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../../services/demo-link.service */
    "./src/app/services/demo-link.service.ts");

    var JsonServerPageContainerComponent = /*#__PURE__*/function () {
      function JsonServerPageContainerComponent(_serv, _dl) {
        _classCallCheck(this, JsonServerPageContainerComponent);

        this._serv = _serv;
        this._dl = _dl;
      }

      _createClass(JsonServerPageContainerComponent, [{
        key: "getCount",
        value: function getCount() {
          ...
          this._serv.getCount().subscribe(function (res) {
            _this43.fetchCount = res["count"];
          });
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          this.subHeaderContent = {
            icon: "fa fa-hdd",
            info: ["Create customised JSON that suits your APP ", "Create INSERT SQL statements and TEST DATA", "Create API with querystring to use directly in your APP  ", "Use default grab and go APIs"],
            showDemoBig: true,
            demoLinkText: "Demo",
            showIconBig: true,
          ...
          this.angularWay = "\n    import { Injectable } from '@angular/core';<br>\n    import { HttpClient, HttpParams } from '@angular/common/http';<br><br>\nimport { GenerateJsonService } from '../../../services/generate-json.service';\n\n    @Injectable()\n    export class ConfigService {<br><br>\n    constructor(private _http: HttpClient){}<br><br>\n\n  *****************************************************<br>\n    You can generate the URL by hitting the \"Generate URL\" button\n    and Use that link directly in your Get request.<br>\n\n   If not then Use the Get method with Parameters to generate the\n   require JSON.\n\n  *****************************************************<br>\n\n\n    let myJson = {\"repeat\": \"1\",  \"name\": \"rand(name)\"};<br><br>\n\n    let url = \"http://localhost:3000/api/generate\" <br> <br>\n    let options =  { params : new HttpParams().set('structure', myJson)}; <br> <br>\n\n    this._http.get( url ,options)<br>.subscribe(\n      <br>res=>{\n        this.generatedData = res ;\n      })<br>\n\n  }\n\n\n    ";
        }
      }, {
        key: "onCloseYt",
        value: function onCloseYt(event) {
          this.showYt = event;
        }
      }]);
    ...
    JsonServerPageContainerComponent.ctorParameters = function () {
      return [{
        type: _services_generate_json_service__WEBPACK_IMPORTED_MODULE_2__["GenerateJsonService"]
      }, {
    ...
    JsonServerPageContainerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-json-server-page-container",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./json-server-page-container.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./json-server-page-container.component.scss */
      "./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.scss"))["default"]]
    })], JsonServerPageContainerComponent);
    /***/
  },

  /***/
  "./src/app/json-server-page/json-server-page-routing.module.ts":
  /*!*********************************************************************!*\
    !*** ./src/app/json-server-page/json-server-page-routing.module.ts ***!
    \*********************************************************************/

  /*! exports provided: JsonServerPageRoutingModule */

  /***/
  function srcAppJsonServerPageJsonServerPageRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JsonServerPageRoutingModule", function () {
      return JsonServerPageRoutingModule;
    });
    /* harmony import */
    ...
    var _container_json_server_page_container_json_server_page_container_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./container/json-server-page-container/json-server-page-container.component */
    "./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.ts");

    var routes = [{
      path: '',
      component: _container_json_server_page_container_json_server_page_container_component__WEBPACK_IMPORTED_MODULE_3__["JsonServerPageContainerComponent"]
    }];

    var JsonServerPageRoutingModule = function JsonServerPageRoutingModule() {
      _classCallCheck(this, JsonServerPageRoutingModule);
    };

    JsonServerPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
      exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
    })], JsonServerPageRoutingModule);
    /***/
  },

  /***/
  "./src/app/json-server-page/json-server-page.module.ts":
  /*!*************************************************************!*\
    !*** ./src/app/json-server-page/json-server-page.module.ts ***!
    \*************************************************************/

  /*! exports provided: JsonServerPageModule */

  /***/
  function srcAppJsonServerPageJsonServerPageModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JsonServerPageModule", function () {
      return JsonServerPageModule;
    });
    /* harmony import */
    ...
    var _container_json_server_page_container_json_server_page_container_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./container/json-server-page-container/json-server-page-container.component */
    "./src/app/json-server-page/container/json-server-page-container/json-server-page-container.component.ts");
    /* harmony import */


    var _json_server_page_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./json-server-page-routing.module */
    "./src/app/json-server-page/json-server-page-routing.module.ts");
    /* harmony import */


    var _components_generator_box_generator_box_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/generator-box/generator-box.component */
    "./src/app/json-server-page/components/generator-box/generator-box.component.ts");
    /* harmony import */


    var _components_how_to_use_how_to_use_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/how-to-use/how-to-use.component */
    "./src/app/json-server-page/components/how-to-use/how-to-use.component.ts");
    /* harmony import */


    var _components_param_info_param_info_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/param-info/param-info.component */
    "./src/app/json-server-page/components/param-info/param-info.component.ts");
    /* harmony import */


    var _reusables_reusables_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../reusables/reusables.module */
    "./src/app/reusables/reusables.module.ts");

    var JsonServerPageModule = function JsonServerPageModule() {
      _classCallCheck(this, JsonServerPageModule);
    };

    JsonServerPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_container_json_server_page_container_json_server_page_container_component__WEBPACK_IMPORTED_MODULE_4__["JsonServerPageContainerComponent"], _components_generator_box_generator_box_component__WEBPACK_IMPORTED_MODULE_6__["GeneratorBoxComponent"], _components_how_to_use_how_to_use_component__WEBPACK_IMPORTED_MODULE_7__["HowToUseComponent"], _components_param_info_param_info_component__WEBPACK_IMPORTED_MODULE_8__["ParamInfoComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _json_server_page_routing_module__WEBPACK_IMPORTED_MODULE_5__["JsonServerPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _reusables_reusables_module__WEBPACK_IMPORTED_MODULE_9__["ReusablesModule"]],
      providers: []
    })], JsonServerPageModule);
    /***/
  }
}]);
//# sourceMappingURL=json-server-page-json-server-page-module-es5.js.map